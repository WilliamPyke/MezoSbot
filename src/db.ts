...
export type DeveloperRelayRouteRow = { guild_id: string; discord_id: string; developer_channel_id: string; private_thread_id: string | null; enabled: boolean; created_by: string | null; created_at: string; updated_at: string };
