...
export type QuestRow = { id: number; guild_id: string; channel_id: string; message_id: string | null; creator_id: string; title: string; description: string | null; status: string; reward_mode: string; max_reward_sats: number; starts_at: string | null; ends_at: string | null; metadata: Record<string, unknown>; created_at: string; updated_at: string; completed_at: string | null };
