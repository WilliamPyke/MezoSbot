...
export type EventQuestRow = { id: number; guild_id: string; channel_id: string; creator_id: string; scheduled_event_id: string; event_name: string; event_channel_id: string; reward_sats: number; min_minutes: number; max_rewards: number | null; rewards_count: number; status: string; scheduled_start_at: string | null; scheduled_end_at: string | null; created_at: string; completed_at: string | null };
