...
CREATE TABLE IF NOT EXISTS deposit_addresses (
  ...
  native_sweep_tx_hash TEXT,
  native_sweep_balance TEXT,
  native_sweep_started_at TIMESTAMPTZ
);
...
CREATE OR REPLACE FUNCTION reserve_token_withdrawal(
  p_discord_id TEXT, p_token TEXT, p_token_amount DOUBLE PRECISION, p_gas_sats DOUBLE PRECISION
) RETURNS TEXT AS $$
